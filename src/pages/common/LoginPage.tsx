export function LoginPage() {
    return (
        <section className='pt-[4rem] bg-violet-900'>
            <form
                ...
                <div className="flex w-full flex-col gap-1">
                    <p>Sign in with</p>
                    <div className="flex w-full flex-col gap-1">
                        <button type="button" className="btn gap-1 bg-gray-5">
                            <svg stroke="currentColor" fill="currentColor" strokeWidth="0" version="1.1"
                                 viewBox="0 0 48 48" enableBackground="new 0 0 48 48" className="h-5 w-5"
              ...
              c0.001-0.001,0.002-0.001,0.003-0.002l6.19,5.238C36.971,39.205,44,34,44,24C44,22.659,43.862,21.35,43.611,20.083z"
                        ...
                        <button type="button" className="btn gap-2 bg-gray-5">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"
                                 className="h-4 w-5 fill-primary">
                                <path
                ...
                <div className="divider my-2 text-xs text-content2">or continue with</div>
                ...
                <div className="form-group">
                    ...
                    <div className="form-field">
                        <div className="form-control">
                            <a className="link link-underline-hover link-primary text-sm">Don't have an account? Sign
                                in</a>
                        </div>
                    </div>
                </div>
