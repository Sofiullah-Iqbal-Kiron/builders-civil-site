    ...
    return (
        <section className='flex flex-col space-y-8'>
            ...
            <div className='flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:justify-around items-center'>
                ...
                <p className='font-mono w-96 font-thin tracking-wide text-md sm:text-lg text-center sm:text-left'>
            ...
            <div className='flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:justify-around items-center'>
                <p className='font-mono w-96 font-thin tracking-wide text-md sm:text-lg text-center sm:text-right'>
