...
export function Hero() {
    return (
        <section id="#hero"
                 className='sm:min-h-screen sm:ps-10 flex flex-col justify-center items-center sm:items-start space-y-10'>
            <motion.p
                initial={{opacity: 0}}
                animate={{opacity: 1}}
            ...
            >
                {/*<a href='#get-started'*/}
                {/*   className='px-4 py-3 bg-gradient-to-r from-yellow-500 to-yellow-200 shadow-xl text-gray-800 font-bold text-md sm:text-2xl rounded flex justify-center items-center space-x-10 w-80'>*/}
